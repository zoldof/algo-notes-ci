...
◆四分位範囲
・第3四分位数から第1四分位数を引いた差
・データを値の大きさ順に並べた時の中央50%のデータの範囲にほぼ等しいため極端に離れた値の影響が小さい[^1]
...
[^1]:数値上の中央値から見て［データ総数の半分］もしくは［その半分に1加算した数］を分子、［データ総数から1減算した数］を分母とする分数が四分位範囲となるので、「ほぼ等しい」という表現である。データ総数が多くなればなるほど全体に対して「1」という加算の影響は小さくなるので、中央50%のデータの範囲に収束していく。
