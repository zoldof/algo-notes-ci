...
- 底面がどのような形であれ上記公式は適用可能である
  ...
  2. 三角錐：三角形は四角形の半分だから
  3. 多角錐：多角形は三角形の集まりだから[^7]
  4. 円錐：円周率は正多角形による近似値だから[^6]:
...
[^4]:例えば10を30にするのに3倍、10を20にするのに2倍、[最小公倍数の仕組み](https://zoldof.github.io/algo-notes/gcd-and-lcm){:target="_blank" rel="noopener noreferrer"}から見ると、正方形の1辺を形成するために、それぞれの倍数が影響し合うことで最小公倍数60が求まる。「最大公約数10によって［横3，縦2］のブロックができ、その最小公倍数は6であり、この6が最大公約数10の倍数である」という見方。
[^5]:aaa
[^6]:bbb
[^7]:ccc
