...
[^4]:例えば10を20にするのに2倍、10を30にするのに3倍、[最小公倍数の仕組み](https://zoldof.github.io/algo-notes/gcd_and_lcm){:target="_blank" rel="noopener noreferrer"}から見ると、正方形の1辺を形成するために、それぞれの倍数が影響し合うことで最小公倍数60が求まる。
