...
- 累乗において$0^0$は未定義である
- 累乗において0でない任意の数をaとした場合、$a^1×a^{-1}=1$であることから$a^0$は1になる
...
[^4]:例えば10を20にするのに2倍、10を30にするのに3倍、[最小公倍数の仕組み](https://zoldof.github.io/algo-notes/gcd_and_lcm)から見ると、正方形の1辺を形成するために、それぞれの倍数が影響し合うことで最小公倍数60が求まる。
